...
kršitev omejitve $ u$, z $ u_{n}$ pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
$$ k_{1} \cdot u_{1} + k_{2} \cdot u_{2} + \dots + k_{n-1} \cdot u_{n-1} + k_{n} \cdot u _{n} $$
...
\subsection[short]{Požrešna metoda} % podrazdelek
...
\subsubsection[short]{Iskanje s tabuji} % podpodrazdelek
...
\subsection[short]{Končni algoritem} % podrazdelek
...
\subsection[short]{Zaključek} % podrazdelek
